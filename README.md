...
- **lisa_data.csv**: Sample data file demonstrating the application's capabilities
...
The `lisa_data.csv` file contains sample data that demonstrates the application's features. You can use this as a starting point or reference for your own data.
